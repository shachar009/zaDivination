...
public class Painter extends MethodProvider
{
	...
	{
		final int expGained = ctx.skills.getExperience(Skills.DIVINATION) - ZaDivination.startingExp;
		final int currentLevel = ctx.skills.getLevel(Skills.DIVINATION);
		final int levelsGained = currentLevel - ZaDivination.startingLevel;
		final long runTime = System.currentTimeMillis()-ZaDivination.startingTime;
